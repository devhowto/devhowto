...
image::../__assets/rspec-example-1-fail.png[rspec failure example]

Update the implementation of `Job#run` to satisfy the test and run it again.

image::../__assets/rspec-example-1-pass.png[rspec example pass]
...
image::../__assets/rspec-autorun-format-progress-dots-1.png[rspec autorun progress dots]
...
image::../__assets/rspec-autorun-format-documentation-1.png[rspec autorun documentation]

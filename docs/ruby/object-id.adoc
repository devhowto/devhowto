...
The bottom (least significant) bit is set to 1 to say “I'm an immediate value”; something regular pointers never do because of pointer alignment.
...
Thanks to zenspider on Ruby discord for explaining this.

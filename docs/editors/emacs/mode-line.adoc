...
With point anywhre inside the `set-face-attribute` expression or even anywhere inside the `cond`, simply press kbd:[C-M-x], or kbd:[M-x eval-defun RET] to try different fonts on the fly.
